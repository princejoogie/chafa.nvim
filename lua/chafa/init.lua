...
local ui = require "chafa.ui"
local dimensions = require "chafa.dimensions"
local api = require "chafa.api"
...
function M.setup(user_opts)
	...
	vim.api.nvim_create_user_command("ViewImage", function()
		async.run(on_image_open, function()
			print "done"
		end)
	end, {
		desc = "View an image in a buffer with chafa",
	})
end
